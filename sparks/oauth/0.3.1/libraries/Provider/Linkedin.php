...
class OAuth_Provider_Linkedin extends OAuth_Provider {
	...
	public function get_user_info(OAuth_Consumer $consumer, OAuth_Token $token)
	{
		...
		$url = 'https://api.linkedin.com/v1/people/~:(id,first-name,last-name,email-address,headline,member-url-resources,picture-url,location,public-profile-url)';
		...
		return array(
			...
			'image' => isset($user['public-profile-url']) ? $user['public-profile-url'] : null
		);
	}
