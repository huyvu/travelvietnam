...
<div class="inner content-13x20">
	...
	<div class="left" style="width: 680px">
		<div id="tour-view-detailed">
			...
			<div id="tour-view-detail">
				<ul class="tabs">
					<li><a id="nav1" class="selected" href="javascript:void(0)" onclick="showTab(0)">Reviews</a></li>
					<li><a id="nav2" href="javascript:void(0)" onclick="showTab(1)">Questions</a></li>
				</ul>
				<div class="clr"></div>
