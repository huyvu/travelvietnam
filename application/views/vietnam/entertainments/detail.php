...
<?
	...
	$entertainment_category = $this->m_entertainment_category->load($item->catid);
?>
<div class="inner content-13x20">
	<div id="breadcrumbs">
		...
		<img alt="" src="<?=IMG_URL?>arrow.png">
		<a class="pathway" title="Vietnam" href="<?=site_url("vietnam/entertainments/{$dest->alias}")?>">Entertainments of <?=$destination->name?></a>
		...
		<div class="sight">
			<div style="width: 680px;float: left">
				<div style="padding: 10px; background: #FFF; overflow: hidden">
					...
					<div class="left highlights">
						<ul>
							...
							<li><span>Type :</span> <?=$entertainment_category->name?></li>
				...
				<div class="left detailed">
					<div>
						<div class="left" style="width: 380px; margin-right: 20px; display:none">
						...
						<div class="left" style="width: 280px;display:none">
			...
			<div class="right">
				<div id="popular-attractions">
					<div class="title">
						<h2>Popular <?=$destination->name?> Entertainments</h2>
					</div>
					<ul>
						<?
						$idx = 0;
						foreach($entertainments as $entertainment) {
							$idx++
						?>
							<li class="<?=($idx>7)?'extra-attraction none':''?>"><a href="<?=site_url("vietnam/entertainments/{$entertainment->alias}")?>"><?=$entertainment->title?></a></li>
						<? } ?>
					</ul>
					<?if(sizeof($entertainments) > 7) :?>
						<span>
...
<script type="text/javascript">
	...
	//Show more attraction link
	/*$("#popular-attractions span a").click(function(event) {
		$("#popular-attractions ul").removeAttr('style');
		$("#popular-attractions span").hide();
	});*/
