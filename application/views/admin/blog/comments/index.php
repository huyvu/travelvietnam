...
<div id="element-box">
	...
	<div class="m">
		<form action="<?=site_url("administrator/update_blog_comment")?>" method="post" name="adminForm">
			<div id="editcell">
						...
						if (!empty($items) && sizeof($items)) {
							...
							foreach ($items as $item) {
								...
								<tr class="row1">
									...
									<td class="title">
										<a href="<?=site_url("administrator/edit_blog_comment/".$item->id)?>"><?=$item->name?></a>
									</td>
									<td>
										<?=$item->email?>
									</td>
									<td width="300px">
										<?
											$blog = $this->m_blog->load($item->blog_id);
											echo $blog->title;
										?>
									</td>
									<td>
