...
<div id="element-box">
	...
	<div class="m">
		<form action="<?=site_url("administrator/update_blog_category")?>" method="post" name="adminForm">
			<div id="editcell">
						...
						if (!empty($items) && sizeof($items)) {
							...
							foreach ($items as $item) {
								...
								<tr class="row1">
									...
									<td class="title">
										<a href="<?=site_url("administrator/edit_blog_category/".$item->id)?>"><?=$item->name?></a>
									</td>
