...
<div id="element-box">
	...
	<div class="m">
		<form method="POST" action="<?=site_url("administrator/update_albums")?>" name="adminForm">
			<div id="editcell">
							...
							foreach ($items as $item) {
								?>
									<tr>
										...
										<td>
											<a href="<?=site_url("administrator/edit_album/".$item->id)?>"><?=$item->name?></a>
										</td>
										<td align="center">
											<? if (!$item->media_type) { ?>
												Photo
										...
										<td align="center">
											<? $info->album_id = $item->id;
												if (!$item->media_type) {
											?>
												<a title="upload photo" href="<?=site_url("administrator/album_photos/".$item->id)?>"><?=sizeof($this->m_album_photo->getItems($info))?></a>
											<? } else { ?>
												<a title="upload video" href="<?=site_url("administrator/album_video/".$item->id)?>"><?=sizeof($this->m_album_video->getItems($info))?></a>
											<? } ?>
										</td>
