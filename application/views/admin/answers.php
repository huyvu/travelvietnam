...
<div id="element-box">
	...
	<div class="m">
		<form action="<?=site_url("administrator/update_answer")?>" method="post" name="adminForm">
			<div id="editcell">
					...
					<?
						if (!empty($questions) && sizeof($questions)) {
							...
							foreach ($questions as $question) {
                            	...
                            	$answers = $this->m_question->getItems($info1);
								?>
								<tr class="row1">
									<td align="center">
										<?=$cnt?>
									...
									<td class="title" width="30%">
										<a href="<?=site_url("administrator/edit_answer/".$question->id)?>"><?=$question->title?></a>
									</td>
									<td class="title" width="30%">
										<?=$question->content?>
									</td>
