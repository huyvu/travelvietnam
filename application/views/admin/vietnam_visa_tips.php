...
<div id="element-box">
	...
	<div class="m">
		<form action="<?=site_url("administrator/update_vietnam_visa_tip")?>" method="post" name="adminForm">
			<div id="editcell">
							...
							foreach ($items as $item) {
								...
								<tr class="row1">
									...
									<td class="title" width="60%">
										<a href="<?=site_url("administrator/edit_vietnam_visa_tip/".$item->id)?>"><?=$item->title?></a>
									</td>
									<td>
										<?=$item->nation?>
									</td>
