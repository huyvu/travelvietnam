...
<div id="element-box">
	...
	<div class="m">
		<form method="POST" action="<?=site_url("administrator/update_hotel_categories")?>" name="adminForm">
			<div id="editcell">
							...
							foreach ($items as $item) {
								?>
									<tr>
										...
										<td class="title">
											<a href="<?=site_url("administrator/edit_hotel_category/".$item->id)?>"><?=$item->name?></a>
										</td>
