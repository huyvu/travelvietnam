...
<div id="element-box">
	...
	<div class="m">
		<form method="POST" action="<?=site_url("administrator/update_tour_destinations")?>" name="adminForm">
			<div id="editcell">
							...
							foreach ($items as $item) {
								?>
									<tr>
										...
										<td class="title">
											<a href="<?=site_url("administrator/edit_tour_destination/".$item->id)?>"><?=$item->name?></a>
										</td>
										<td>
											<?=$item->region?>
										</td>
