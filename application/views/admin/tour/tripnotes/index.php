...
<div id="element-box">
	...
	<div class="m">
		<form method="POST" action="<?=site_url("administrator/update_tour_tripnotes")?>" name="adminForm">
							...
							foreach ($items as $item) {
								?>
									<tr>
										...
										<td class="title">
											<a href="<?=site_url("administrator/edit_tour_tripnote/".$item->id)?>"><?=$item->title?></a>
										</td>
										<td>
										...
										<td class="order" colspan="2" width="100px">
											<span><a href="#reorder" onclick="return listItemTask('cb<?=$idx-1?>','orderupList')" title="Move Up"><img src="<?=IMG_URL?>admin/uparrow.png" width="16" height="16" border="0" alt="Move Up" /></a></span>
											<span><a href="#reorder" onclick="return listItemTask('cb<?=$idx-1?>','orderdownList')" title="Move Down"><img src="<?=IMG_URL?>admin/downarrow.png" width="16" height="16" border="0" alt="Move Down" /></a></span>
