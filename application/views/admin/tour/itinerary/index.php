...
<div id="element-box">
	...
	<div class="m">
		<form method="POST" action="<?=site_url("administrator/update_tour_itineraries")?>" name="adminForm">
							...
							foreach ($items as $item) {
								?>
									<tr>
										...
										<td class="title">
											<a href="<?=site_url("administrator/edit_tour_itinerary/".$item->id)?>"><?=$item->title?></a>
										</td>
										<td>
