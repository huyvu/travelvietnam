...
<div id="element-box">
	...
	<div class="m">
		<form action="<?=site_url("administrator/update_cuisines")?>" method="post" name="adminForm">
			<div id="editcell">
							...
							foreach ($items as $item) {
								...
								<tr class="row1">
									...
									<td class="title" width="40%">
										<a href="<?=site_url("administrator/edit_cuisine/".$item->id)?>"><?=$item->title?></a>
									</td>
									<td>
										<?=$this->m_cuisine_category->load($item->catid)->name?>
									</td>
