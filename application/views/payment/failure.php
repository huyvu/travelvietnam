		...
		<div class="view-content">
			<div class="detail">
				<div>
					...
					<p style="font-size:14px;">
						You might want to <a href="<?=BASE_URL.'/tours/booking/review'?>">click here</a> to process your payment again now and all payment must 
					...
					<hr>
					<div id="try-again">
						<a id="btnTryAgain" href="<?=BASE_URL.'/tours/booking/review'?>">TRY AGAIN</a>
					</div>
