...
<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-generic">
			Entertainment Category: <small><small>[ Edit ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		...
		<form id="adminForm" name="adminForm" method="post" action="<?=site_url("administrator/update_entertainment_categories")?>">
