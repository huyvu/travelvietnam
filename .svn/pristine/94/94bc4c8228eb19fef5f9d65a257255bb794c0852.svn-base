<div class="inner content-13x20">
	<div id="breadcrumbs">
		...
		<img alt="" src="<?=IMG_URL?>arrow.png"> Entertainments in Vietnam
		<? require_once(APPPATH."views/module/social.php"); ?>
	</div>
	<h1 class="page-title">ENTERTAINMENTS IN VIETNAM</h1>
	...
	<div class="right">
		<div id="vietnam-view-nav">
			<ul>
				...
				<li>
					<a class="entertainment-selected" title="" href="<?=site_url("vietnam/entertainments")?>">ENTERTAINMENTS</a>
				</li>
				<li>
