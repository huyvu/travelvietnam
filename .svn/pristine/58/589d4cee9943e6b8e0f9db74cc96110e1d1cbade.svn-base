				...
				<tbody>
					<tr>
						<td id="toolbar-cancel" class="button">
							<a class="toolbar" href="<?=site_url("administrator/hotel_booking")?>">
	...
	<div class="m">
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tbody>
				<tr>
					<td valign="top">
						<div class="title">BOOKING #H<?=$item->id?></div>
						<table class="detail">
							<tbody>
								<tr>
									<td>Hotel</td><td>:</td>
									<td><?=$this->m_hotel->load($item->hotel_id)->name?></td>
								</tr>
								<tr>
						...
						<table class="tbltraveler">
							<tbody>
								...
								<?
									$paxs = $this->m_hotel->getPaxs($item->id);
									foreach ($paxs as $pax) {
									?>
								<tr>
									<td><?=$pax->fullname?></td>
