...
<div class="inner content-13x20">
	<div id="breadcrumbs">
		...
		<img alt="" src="<?=IMG_URL?>arrow.png">Shopping of <?=$dest->title?>
		<?endif?>
		<? require_once(APPPATH."views/module/social.php"); ?>
	</div>
	<h1 class="page-title"><?=(isset($dest))?strtoupper($dest->title)."'S SHOPPING":"SHOPPING IN VIETNAM"?></h1>
	...
	<div class="right">
		...
		<div id="todo-filter-widget">
			<div class="container">
				<form id="filter-form" action="<?=site_url("vietnam/shopping")?>" method="POST">
