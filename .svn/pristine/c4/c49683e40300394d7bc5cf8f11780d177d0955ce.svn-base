...
<div id="element-box">
	...
	<div class="m">
		<form action="<?=site_url("administrator/update_entertainments")?>" method="post" name="adminForm">
			<div id="editcell">
							...
							foreach ($items as $item) {
								...
								<tr class="row1">
									...
									<td class="title" width="60%">
										<a href="<?=site_url("administrator/edit_entertainment/".$item->id)?>"><?=$item->title?></a>
									</td>
									<td align="center">
										<? $info->category_id = 13; $info->ref_id = $item->id; ?>
