...
<div id="element-box">
	...
	<div class="m">
		<form action="<?=site_url("administrator/update_tour_option_categories")?>" method="post" name="adminForm">
			<div id="editcell">
							...
							foreach ($items as $item) {
								...
								<tr class="row1">
									...
									<td class="title" width="50%">
										<a href="<?=site_url("administrator/edit_tour_option_categories/".$item->id)?>"><?=$item->name?></a>
									</td>
