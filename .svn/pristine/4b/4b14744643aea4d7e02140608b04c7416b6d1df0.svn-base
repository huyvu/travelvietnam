<?
	...
	$embeded_video	= isset($item->embeded_video) ? $item->embeded_video : "";
...
<div id="toolbar-box">
	...
	<div class="m">
		...
		<div class="header icon-48-generic">
			Album Video: <small><small>[ Edit ]</small></small>
		</div>
		<div class="clr"></div>
	</div>
	<div class="b">
...
<div id="element-box">
	...
	<div class="m">
		...
		<form id="adminForm" name="adminForm" method="post" action="<?=site_url("administrator/update_album_video")?>">
						...
						<td valign="top">
							<table class="adminform">
								<tbody>
									...
									<tr valign="top">
										<td width="10%">
											<label for="name">Embeded Video:</label>
										</td>
										<td width="100%">
											<textarea name="embeded_video" style="width:100%; height:120px"><?=$embeded_video?></textarea>
										</td>
									</tr>
									<tr>
										<td width="10%">
