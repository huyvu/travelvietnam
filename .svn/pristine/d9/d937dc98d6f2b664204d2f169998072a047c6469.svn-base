			...
			<table class="toolbar">
				<tr>
					<td class="button" style="padding-right: 50px">
						<form method="POST" action="<?=site_url("administrator/search_hotel_booking")?>" name="searchForm">
...
<div id="element-box">
	...
	<div class="m">
		<form method="POST" action="<?=site_url("administrator/hotel_booking")?>" name="adminForm">
			<div id="editcell">
								...
								?>
									<tr class="row0">
										...
										<td width="70" align="center">
											<a href="<?=site_url("administrator/hotel_booking_detail/".$item->id)?>"><?="H".$item->id?></a>
										</td>
										...
										<td>
											<?=$this->m_hotel->load($item->hotel_id)->name?>
										</td>
										<td width="10%">
											
										</td>
										<td width="6%" align="center">
											<?=date("M/d/Y", strtotime($item->checkin))?>
										</td>
