...
<div id="element-box">
	...
	<div class="m">
		<form method="POST" action="<?=site_url("administrator/update_rooms")?>" name="adminForm">
							...
							foreach ($items as $item) {
								?>
									<tr>
										...
										<td class="title">
											<a href="<?=site_url("administrator/edit_room/".$item->id)?>"><?=$item->name?></a>
										</td>
										<td>
											<a href="<?=site_url("administrator/edit_hotel/".$item->hotel_id)?>"><?=$this->m_hotel->load($item->hotel_id)->name?></a>
										</td>
										<td align="center">
											<?=$item->room_type?>
										</td>
										...
										<td align="center">
											<a href="<?=site_url("administrator/edit_room_rates/".$item->id)?>">Edit</a>
										</td>
