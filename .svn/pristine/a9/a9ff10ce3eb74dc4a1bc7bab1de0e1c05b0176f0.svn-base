...
<div id="element-box">
	...
	<div class="m">
		<form action="<?=site_url("administrator/update_vietnam_holidays")?>" method="post" name="adminForm">
			<div id="editcell">
							...
							foreach ($items as $item) {
								...
								<tr class="row1">
									...
									<td class="title" width="50%">
										<a href="<?=site_url("administrator/edit_vietnam_holidays/".$item->id)?>"><?=$item->name?></a>
									</td>
